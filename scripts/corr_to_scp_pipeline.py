...
la generación de matrices SCP de múltiples sujetos de manera
...
from tesis.features import scp_pipeline
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Pipeline de transformacion de matrices de correlacion a una matriz scp"
    )
    parser.add_argument(
        "--input-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Directorio de salida (matriz scp)",
    )
    parser.add_argument(
        "--workers",
        type=int,
